...
void R_Register( void ) 
{
	...
	r_volumetricFogHeightOpaque = ri_Cvar_Get_NoComm("r_volumetricFogHeightOpaque", "0", CVAR_ARCHIVE, "Froxel fog height fog: distance at which the medium at the base height becomes opaque, as fogParms depthForOpaque (world units), 0 = off");
	ri.Cvar_CheckRange(r_volumetricFogHeightOpaque, 0.0f, 1000000.0f, qfalse);
	r_volumetricFogHeightBase = ri_Cvar_Get_NoComm("r_volumetricFogHeightBase", "0", CVAR_ARCHIVE, "Froxel fog height fog: world Z of the base height, set to the spawn point Z when a map loads");
