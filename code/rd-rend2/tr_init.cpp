...
void R_Register( void ) 
{
	...
	r_weatherWetRoughness = ri_Cvar_Get_NoComm( "r_weatherWetRoughness", "0.5", CVAR_ARCHIVE, "Roughness multiplier of fully wet surfaces" );
	r_weatherWetDarkening = ri_Cvar_Get_NoComm( "r_weatherWetDarkening", "0.35", CVAR_ARCHIVE, "Diffuse albedo darkening of fully wet rough dielectrics" );
	r_weatherWetNormal = ri_Cvar_Get_NoComm( "r_weatherWetNormal", "0.3", CVAR_ARCHIVE, "Normal map flattening of fully wet surfaces" );
	r_weatherWetBias = ri_Cvar_Get_NoComm( "r_weatherWetBias", "2", CVAR_ARCHIVE, "Rain occlusion depth bias in world units" );
	r_weatherWetnessDebug = ri_Cvar_Get_NoComm( "r_weatherWetnessDebug", "0", CVAR_CHEAT, "1 rain exposure, 2 wetness mask (magenta: excluded), 3 effective roughness, 4 dry / wet split, 5 puddle slope, 6 puddle noise, 7 exposure x slope, 8 puddle mask, 9 puddle roughness, 10 puddle eligibility, 11 material height (magenta: none), 12 height low / high, 13 macro puddle mask, 14 micro depression mask, 15 combined puddle" );
