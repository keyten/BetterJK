...
void R_Register( void ) 
{
	...
	r_forwardPlusDebug = ri_Cvar_Get_NoComm( "r_forwardPlusDebug", "0", CVAR_CHEAT, "Forward+ debug view: 1 tiles, 2 depth slice, 3 cluster, 4 lights per cluster, 5 overflow, 6 shadowed lights, 7 unshadowed lights, 8 light spheres, 9 light r_forwardPlusDebugLight" );
